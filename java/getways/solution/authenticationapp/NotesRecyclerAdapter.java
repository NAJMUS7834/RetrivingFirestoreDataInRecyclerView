...
//file we have to include in this project to implent recycler view is Note class main class & note_row
public class NotesRecyclerAdapter extends FirestoreRecyclerAdapter<Note, NotesRecyclerAdapter.NoteViewHolder> {
    ...
    public NotesRecyclerAdapter(@NonNull FirestoreRecyclerOptions<Note> options, MainActivity mainActivity) {
        super(options);
    ...
    protected void onBindViewHolder(@NonNull NoteViewHolder holder, int position, @NonNull Note note) {
        ...
        /**change element type which we want to inflate in our relative layout section*****/
    ...
    public NoteViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        /****layout file which we want to inflate***/
